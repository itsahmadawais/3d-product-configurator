			...
			if ( dependants.length > 0 ) {
				...
				dependants.each( function( i, e ) {
					...
					if ( 'undefined' !== typeof currentFieldName && '' !== currentFieldName && $.inArray( currentFieldName, dependantsSeen ) < 0 ) {
						...
						var currentFieldType = currentParent.parents( '.cmb-row:first' ).attr('data-fieldtype');

						if( currentFieldType == 'efgroup' || currentFieldType == 'text' || currentFieldType == 'object' || currentFieldType == 'group' || currentFieldType == 'pattern' || currentFieldType == 'gradient' || currentFieldType == 'material' || currentFieldType == 'image' || currentFieldType=='choices' || currentFieldType=='fabricgallery') {
